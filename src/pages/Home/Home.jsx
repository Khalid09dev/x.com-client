...
const Home = () => {
    return (
        <div className="grid h-screen">
            <div className="flex justify-center gap-44 bg-[#000000] pt-20">
            <div className="pt-24">
            ...
            <div>
                ...
                <button className="bg-[#1D9BF0] rounded-3xl py-2 w-1/2 text-white text-[15px] font-semibold">Create account</button>
